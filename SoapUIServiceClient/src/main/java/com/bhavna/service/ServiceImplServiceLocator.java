...
public class ServiceImplServiceLocator extends org.apache.axis.client.Service implements com.bhavna.service.ServiceImplService {
    ...
    private java.lang.String ServiceImpl_address = "http://localhost:8080/SoapUIService/services/ServiceImpl";
    ...
    public com.bhavna.service.ServiceImpl getServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.bhavna.service.ServiceImpl getServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bhavna.service.ServiceImplSoapBindingStub _stub = new com.bhavna.service.ServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bhavna.service.ServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bhavna.service.ServiceImplSoapBindingStub _stub = new com.bhavna.service.ServiceImplSoapBindingStub(new java.net.URL(ServiceImpl_address), this);
                _stub.setPortName(getServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.bhavna.com", "ServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.bhavna.com", "ServiceImpl"));
        }
